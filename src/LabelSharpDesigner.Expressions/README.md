# LabelSharpDesigner.Expressions
...
Ele é totalmente independente — não depende nem do `LabelSharpDesigner.Core`. Só sabe interpretar
...
O `LabelSharpDesigner.Layout` é o único consumidor direto — é lá que o `LayoutEngine` chama o
