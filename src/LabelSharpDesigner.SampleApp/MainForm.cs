...
using LabelSharpDesigner.SampleApp.Printing;
using LabelSharpDesigner.SampleApp.Products;

namespace LabelSharpDesigner.SampleApp;

/// <summary>Dashboard for this sample app: products, labels (reusing the LabelSharpDesigner plugin's
...
public sealed class MainForm : Form
{
    ...
    public MainForm(ProductRepository productRepository, LibraryRepository labelRepository)
    {
        ...
        Text = "LabelSharpDesigner — Exemplo de uso";
        Width = 480;
        Height = 320;
        ...
        var labelsButton = NewMenuButton("Etiquetas", "Criar e listar etiquetas (LabelSharpDesigner)");
