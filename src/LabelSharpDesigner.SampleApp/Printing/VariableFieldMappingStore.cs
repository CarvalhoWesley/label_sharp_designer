...
/// <c>%APPDATA%\LabelSharpDesigner\SampleApp\variable-field-mappings.json</c>, keyed by label id
/// (<see cref="LabelSharpDesigner.App.Library.LibraryEntry.Id"/>) so every saved label remembers its
