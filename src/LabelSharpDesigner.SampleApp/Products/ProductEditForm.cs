namespace LabelSharpDesigner.SampleApp.Products;

/// <summary>Create/edit dialog for a single <see cref="Product"/> — <see cref="Result"/> is set only
/// when the user confirms with valid data, mirroring <c>PageSettingsForm</c>'s "compute a result,
/// don't let the caller reach into live controls" shape.</summary>
