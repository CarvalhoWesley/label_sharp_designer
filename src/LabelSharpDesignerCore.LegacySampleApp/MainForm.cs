...
using LabelSharpDesignerCore.LegacySampleApp.Printing;
...
/// this application (its own repositories, its own list/CRUD screens) — the LabelSharpDesignerCore
...
public sealed class MainForm : Form
{
    ...
    public MainForm(ProductRepository productRepository, LabelRepository labelRepository)
    {
        ...
        Text = "LabelSharpDesignerCore — Exemplo .NET Framework 4.x";
        Width = 480;
        Height = 360;
        ...
        var settingsButton = NewMenuButton("Configurações", "Localizar o LabelSharpDesignerCore.App.exe usado para editar etiquetas");
