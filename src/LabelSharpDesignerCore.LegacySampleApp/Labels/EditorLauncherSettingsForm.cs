...
/// published <c>LabelSharpDesignerCore.App.exe</c> satellite lives (INTEGRATION.md §3.1), which element
...
public sealed class EditorLauncherSettingsForm : Form
{
    ...
    public EditorLauncherSettingsForm()
    {
        ...
        {
            Text = "Caminho do LabelSharpDesignerCore.App.exe (publicado separadamente — INTEGRATION.md §3.1):",
            Left = left,
            Top = top,
            Width = 520,
            Height = 34,
    ...
    private void Browse()
    {
        ...
        {
            Title = "Localizar LabelSharpDesignerCore.App.exe",
            Filter = "LabelSharpDesignerCore.App.exe|LabelSharpDesignerCore.App.exe|Executável (*.exe)|*.exe",
        };
    ...
    private void AutoDetect()
    {
        ...
        if (detected is null)
        {
            MessageBox.Show(this, "Não foi possível localizar automaticamente. Publique o LabelSharpDesignerCore.App (INTEGRATION.md §3.1) ou use \"Procurar...\".", "Configurações", MessageBoxButtons.OK, MessageBoxIcon.Information);
            return;
        }
    ...
    private void TrySave()
    {
        ...
        {
            MessageBox.Show(this, "Informe um caminho válido para o LabelSharpDesignerCore.App.exe.", "Configurações", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            return;
        }
