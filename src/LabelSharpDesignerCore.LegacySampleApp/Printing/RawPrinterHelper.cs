...
/// document to render.
///
/// <para>This app cannot reference <c>LabelSharpDesignerCore.PrintTransport.Windows</c> (it targets
...
internal static class RawPrinterHelper
{
    ...
    public static void SendBytesToPrinter(string printerName, byte[] bytes, string documentName = "LabelSharpDesignerCore")
    {
