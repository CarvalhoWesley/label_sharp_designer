...
/// <summary>Resolves the path to the published <c>LabelSharpDesigner.App.exe</c> satellite that
...
/// <c>LabelSharpDesigner.App</c>.</summary>
internal static class EditorLauncherLocator
{
    private const string ExeFileName = "LabelSharpDesigner.App.exe";
    ...
    /// <c>src\LabelSharpDesigner.App\bin\{Release,Debug}\net9.0-windows*\LabelSharpDesigner.App.exe</c>
    ...
    public static string? TryAutoDetect()
    {
        ...
        {
            var binRoot = Path.Combine(directory.FullName, "src", "LabelSharpDesigner.App", "bin");
