...
/// <c>%APPDATA%\LabelSharpDesigner\Labels</c>, which belongs to the plugin's <c>LibraryRepository</c>
...
public sealed class LabelRepository
{
    ...
    /// <summary>Opens this app's own label folder (<c>%APPDATA%\LabelSharpDesigner\LegacySampleApp\Labels</c>),
