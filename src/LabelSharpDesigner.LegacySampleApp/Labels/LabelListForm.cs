...
/// <c>LabelSharpDesigner.App.exe</c> as a satellite process and blocking until the user closes it
...
public sealed class LabelListForm : Form
{
    ...
    private void OpenEditor(LabelEntry entry)
    {
        ...
        if (exePath is null)
        {
            MessageBox.Show(
                this,
                "O caminho do LabelSharpDesigner.App.exe (o editor do plugin) ainda não está configurado.",
                "Editor de etiquetas",
