# LabelSharpDesigner.Serialization
...
Se você está integrando o LabelSharpDesigner numa aplicação própria, não precisa entender o formato
...
Depende só de `LabelSharpDesigner.Core` (o modelo que ele serializa). Multi-targeta
