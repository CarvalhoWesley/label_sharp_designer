...
public sealed class PrintSettings
{
    ...
    /// see <see cref="LabelSharpDesigner.Rendering.ArgoxPpla.ArgoxRendererOptions.OffsetXMm"/>/
...
/// <summary>Mirrors <see cref="LabelSharpDesigner.Rendering.ArgoxPpla.ArgoxTransferType"/> — kept as
