...
outro projeto do LabelSharpDesignerCore. Pense nele como "os substantivos" do sistema — as classes
...
estranho no começo, mas é o que permite o undo/redo do projeto `LabelSharpDesignerCore.History`
