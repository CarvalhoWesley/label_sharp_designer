# LabelSharpDesignerCore.Barcode
...
resolve um `BarcodeElement`/`QrCodeElement` através do `LabelSharpDesignerCore.Layout` e desenha o
...
Depende de `LabelSharpDesignerCore.Core` (para os tipos de simbologia/elemento). Multi-targeta
