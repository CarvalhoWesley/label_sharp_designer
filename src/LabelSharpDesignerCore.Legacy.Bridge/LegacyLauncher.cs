...
/// referenceable from net462/net472) to start the satellite <c>LabelSharpDesignerCore.App.exe</c> over a
...
public sealed class LegacyLauncher
{
    ...
    /// <param name="appExecutablePath">Full path to <c>LabelSharpDesignerCore.App.exe</c> — deployment
