...
/// <summary>
/// What the legacy ASP.NET Framework app asks the satellite <c>LabelSharpDesignerCore.App</c> process to
...
public sealed record LaunchRequest
{
    ...
    /// this project can't reference <c>LabelSharpDesignerCore.App</c>'s actual enum (wrong dependency
