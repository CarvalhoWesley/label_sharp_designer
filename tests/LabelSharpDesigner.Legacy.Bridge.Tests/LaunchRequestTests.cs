namespace LabelSharpDesigner.Legacy.Bridge.Tests;
...
public class LaunchRequestTests
{
    ...
    {
        var request = new LaunchRequest { FilePath = @"C:\Program Files\LabelSharpDesigner\a.label" };

        Assert.Equal("--edit \"C:\\Program Files\\LabelSharpDesigner\\a.label\"", request.ToCommandLineArguments());
    }
    ...
    public void EncodeThenDecode_RoundTripsAPathWithSpaces()
    {
        ...
        var original = new LaunchRequest { FilePath = @"C:\Program Files\LabelSharpDesigner\a b.label", ReadOnly = true };
